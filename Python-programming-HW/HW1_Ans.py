...
# Fill in this blank with your student ID number: B093040003
...
cmd="p=sorted(s[:-4:4])+sorted(s[2::3])+sorted(s[-2])+sorted(s[1])+sorted(s[1])+sorted(s[3]);print(s,t,p)"
...
s="dirty room"
cmd="p=s[::19]+s[9-1]+s[2]+s[-1]+s[1]+s[1+2]+s[-2:2:-2];print(s,t,p)"
