...
def _ok(r,c):
    ...
    return (B[r-1][c-1]==' ') and r or False
...
def insert(c):
    ...
    r=(_ok(6,c)) and 6 or ((_ok(5,c)) and 5 or ((_ok(4,c)) and 4 or ((_ok(3,c)) and 3 or ((_ok(2,c)) and 2 or ((_ok(1,c)) and 1 or False)))))
    #Add Line #2 of insert() here.
    B[r-1][c-1] = (isFilled[0]) and '●' or '○'
...
def makeAmove():
    ...
    print((isFilled[0]) and '●' or '○'," chooses the ",n,(n==1) and 'st' or ((n==2) and 'nd' or (n==3) and 'rd' or 'th')," column.",sep="")
